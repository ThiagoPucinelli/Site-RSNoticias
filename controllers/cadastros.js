...
router.get("/", async (req, res) => {
    try {
        ...
        const cadastros = await dbKnex("cadastros").orderBy("nome", "asc");
...
router.post("/", async (req, res) => {
    ...
    try {
        // insert, faz a inserção na tabela pessoas (e retorna o id do registro inserido)
...
router.put("/:id", async (req, res) => {
    ...
    const { nome_cad,email_cad,senha_cad } = req.body; // campo a ser alterado
    try {
